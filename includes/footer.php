    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link text-white-50" href="about.php">เกี่ยวกับเรา</a>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <?php
                if (!$_SESSION['id']) { ?>
                <a class="btn btn-link text-white-50" href="register.php">สมัครสมาชิก</a>
                <a class="btn btn-link text-white-50" href="login.php">เข้าสู่ระบบ</a>
                <?php } else { ?>
                <a href="manage/index.php" class="btn btn-link text-white-50">จัดการ</a>
                <a href="manage/logout.php" class="btn btn-link text-white-50">ออกจากระบบ</a>
                <?php } ?>
            </div>
        </div>
    </div>
