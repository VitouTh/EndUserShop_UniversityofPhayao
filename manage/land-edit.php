...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <?php
        $sql = "SELECT * FROM `land` WHERE `id` = '" . $_GET['id'] . "'";
            ...
            <div class="container">
                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 185, 142, .3)">
                        <form action="sql/land-update.php" method="post" enctype="multipart/form-data">
                            <div class="row g-3">
                                    ...
                                    <div class="form-floating">
                                        <div class="custom-file">
                                            ...
                                            <img id="imgUpload" style="width: 500px;"
                                                src="../img/land/<?php echo $row['image']; ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-floating">
                                        <select class="form-select border-1 py-3" aria-hidden="true" name="type"
                                            ...
                                            <option value="เครื่องใช้ไฟฟ้า"
                                                <?php echo $row['type'] == 'เครื่องใช้ไฟฟ้า' ? 'selected' : ''; ?>>เครื่องใช้ไฟฟ้า
                                            </option>
                                            <option value="เสื้อผ้า"
                                                <?php echo $row['type'] == 'เสื้อผ้า' ? 'selected' : ''; ?>>เสื้อผ้า</option>
                                            <option value="ของใช้ทั่วไป"
                                                <?php echo $row['type'] == 'ของใช้ทั่วไป' ? 'selected' : ''; ?>>ของใช้ทั่วไป
                                            </option>
                                            <option value="รองเท้า"
                                                <?php echo $row['type'] == 'รองเท้า' ? 'selected' : ''; ?>>รองเท้า
                                            </option>
                                            <option value="กระเป๋า"
                                                <?php echo $row['type'] == 'กระเป๋า' ? 'selected' : ''; ?>>กระเป๋า
                                            </option>
                                            <option value="หนังสือ"
                                                <?php echo $row['type'] == 'หนังสือ' ? 'selected' : ''; ?>>หนังสือ
                                            </option>
                                            <option value="อื่นๆ"
                                                <?php echo $row['type'] == 'อื่นๆ' ? 'selected' : ''; ?>>อื่นๆ
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select border-1 py-3" aria-hidden="true" name="for"
                                            ...
                                            <option value="ขาย" <?php echo $row['for'] == 'ขาย' ? 'selected' : ''; ?>>
                                                ขาย</option>
                                            <option value="รับซื้อ" <?php echo $row['for'] == 'รับซื้อ' ? 'selected' : ''; ?>>
                                            รับซื้อ</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="land" name="land"
                                            placeholder="หัวข้อ" required value="<?php echo $row['land']; ?>">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="d-none" name="detail" id="detail" rows="10"
                                            cols="80"><?php echo  str_replace('./', '../../../', $row['detail']); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="address" name="address"
                                            placeholder="จังหวัด" required value="<?php echo $row['address']; ?>">
                                        <label for="address">จังหวัด</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="rai" name="rai" placeholder="ไร่"
                                            required value="<?php echo $row['rai']; ?>">
                                ...
                                <div class="col-md-3">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="price" name="price"
                                            placeholder="ราคา" required value="<?php echo $row['price']; ?>">
                                        <label for="price">ราคา</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <select class="form-select border-1 py-3" aria-hidden="true" name="status"
                                            placeholder="สถานะ" required>
                                            <option value="">--- สถานะ ---</option>
                                            <option value="ว่าง"
                                                <?php echo $row['status'] == 'ว่าง' ? 'selected' : ''; ?>>ว่าง
                                            </option>
                                            <option value="ขายแล้ว"
                                                <?php echo $row['status'] == 'ขายแล้ว' ? 'selected' : ''; ?>>ขายแล้ว
                                            </option>
