...
<body>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-12 wow fadeIn" data-wow-delay="0.1s">
                        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s"
                            ...
                            <h3 class="mb-3">blacklist</h3>
                            <a href="blacklist-add.php" class="btn btn-primary btn" style="width: 200px;"> เพิ่มรายชื่อผู้โกง</a>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 150px;">
                                        <a href="blacklist-edit.php?id=<?php echo $row['id']; ?>"
    ...
    function deleteItem(id) {
        if (confirm('ต้องการลบข้อมูลสมาชิกนี้หรือไม่') == true) {
            window.location = `sql/blacklist-delete.php?id=${id}`;
        }
    };
