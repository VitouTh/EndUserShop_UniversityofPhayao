...
<body>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-12 wow fadeIn" data-wow-delay="0.1s">
                        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s"
                            ...
                            <h3 class="mb-3">ลบคอมเมนต์</h3>
                            <a href="com.php" class="btn btn-primary btn" style="width: 200px;"> ย้อนกลับ</a>
                        </div>
                        ...
                        <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">ลบคอมเมนต์ </th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                if ($row_me['role'] == 'admin') {
                                    $sql = "SELECT * FROM `comments` ORDER BY `name` DESC";
                                } else {
                                    $sql = "SELECT * FROM `comments` WHERE `name` = '" . $row_me['name'] . "' ORDER BY `id` DESC";
                                }
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 200px;">
                                       ...
                                       <!-- <a href="comup.php?id=<?php echo $row['id']; ?>"
    ...
    function deleteItem(id) {
        if (confirm('ต้องการลบข้อมูลประกาศนี้หรือไม่') == true) {
            window.location = `sql/comde.php?id=${id}`;
        }
    };
