...
<body>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-12 wow fadeIn" data-wow-delay="0.1s">
                        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s"
                            ...
                            <h3 class="mb-3">ประกาศ</h3>
                            <a href="land-add.php" class="btn btn-primary btn" style="width: 200px;"> เพิ่ม ประกาศ</a>
                        </div>
                        ...
                        <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                if ($row_me['role'] == 'admin') {
                                    $sql = "SELECT * FROM `view_land` ORDER BY `id` DESC";
                                } else {
                                    $sql = "SELECT * FROM `view_land` WHERE `user_id` = '" . $row_me['id'] . "' ORDER BY `id` DESC";
                                }
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $row['for']; ?></td>
                                    <td><?php echo $row['land']; ?></td>
                                    <td><?php echo $row['address']; ?></td>
                                    <td class="text-center"><?php echo $row['status']; ?></td>
                                    <td class="text-center" style="width: 200px;">
                                        <a href="../detail.php?id=<?php echo $row['id']; ?>" target="_blank"
                                            class="btn btn-info btn-sm" style="width: 60px;">แสดง</a>
                                        <a href="land-edit.php?id=<?php echo $row['id']; ?>"
    ...
    function deleteItem(id) {
        if (confirm('ต้องการลบข้อมูลประกาศนี้หรือไม่') == true) {
            window.location = `sql/land-delete.php?id=${id}`;
        }
    };
